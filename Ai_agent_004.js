      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="flex-1 flex flex-col overflow-hidden">
          <div className="flex-1 p-4 overflow-y-auto space-y-4">
            ...
            <ProjectPhase phase="Planning" progress={0} steps={["Create component", "Implement logo", "Add links", "Create menu", "Add animations"]} />
            <ProjectPhase phase="Execution" progress={65} currentStep="Adding navigation links" />
          </div>

          <div className="border-t p-4">
            <div className="flex gap-2">
              <Textarea placeholder="Describe your request..." className="min-h-[60px]" />
...
function ProjectPhase({ phase, progress, steps = [], currentStep }) {
    ...
    <div className="flex">
      <div className="bg-muted rounded-lg p-3 max-w-[80%]">
        <div className="flex items-center gap-2 mb-2">
          ...
          <Badge variant="outline" className="ml-auto">{isPlanning ? "Planning" : "In Progress"}</Badge>
        </div>
        {isPlanning ? (
          <>
            <p className="text-sm mb-2">Plan Overview:</p>
          ...
          <>
            <p className="text-sm mb-2">Progressing on the project...</p>
